...
public class ReporteController {
    ...
    public Pageable<List<ReporteEntity>> ListarReporteSalidas(@RequestParam(required = false) String tipoTransferencia,
        ...
        try {
            Pageable<List<ReporteEntity>> response = reporteService.ListarReporteSalidas(tipoTransferencia,nuIdAlmacen,tipoEspecie,periodo,fechaInicio, fechaFin,numeroDocumento, numeroActa, tipo, nuIdTransferencia, p);
