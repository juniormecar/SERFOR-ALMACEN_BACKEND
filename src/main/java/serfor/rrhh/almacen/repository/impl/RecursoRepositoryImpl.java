...
public class RecursoRepositoryImpl extends JdbcDaoSupport implements RecursoRepository {
    ...
    public ResultClassEntity RegistrarRecurso(RecursoEntity recursoEntity) {
        ...
        try {
            ...
            spr.registerStoredProcedureParameter("FlgValidaPAS", Integer.class, ParameterMode.IN);
            ...
            spr.setParameter("FlgValidaPAS", recursoEntity.getFlgValidaPAS());
            ...
            for (RecursoProductoEntity pro : recursoEntity.getLstEspecie()) {
                ...
                srepro.registerStoredProcedureParameter("txObservaciones", String.class, ParameterMode.IN);
                ...
                srepro.setParameter("txObservaciones", pro.getTxObservaciones());
                srepro.execute();
    ...
    private Pageable<List<RecursoEntity>> setResultDataListarRecurso(Page page, List<Object[]> dataDb) throws Exception {
        ...
        for (Object[] row : dataDb) {
            ...
            reEntity.setFlgValidaPAS((Integer) row[19]);
            //reEntity.setTipoDocumento((String) row[19]);
            //reEntity.setNumeroDocumento((String) row[20]);
            reEntity.setTxDescEstadoRecurso((String) row[20]);
            reEntity.setNuIdAlmacen((Integer) row[21]);
            reEntity.setTipoIngreso((String) row[22]);
            reEntity.setTipoIngresoDesc((String) row[23]);
            reEntity.setNombres((String) row[24]);
            reEntity.setDireccion((String) row[25]);
            reEntity.setFoto((String) row[26]);
            reEntity.setTipoInfraccion((String) row[27]);
            reEntity.setTipoSancion((String) row[28]);
            reEntity.setTxNombreAlmacen((String) row[29]);
            reEntity.setTipoDocumentoConductor((String) row[30]);
            reEntity.setNumeroDocumentoConductor((String) row[31]);
            reEntity.setNombresConductor((String) row[32]);
            reEntity.setPlaca((String) row[33]);
            reEntity.setFechaIngreso((Date) row[34]);
            reEntity.setHoraIngreso((String) row[35]);
            reEntity.setNuIdArchivoRecurso((Integer) row[50]);
            RecursoPersonaEntity recursoPersonaEntity = new RecursoPersonaEntity();
            recursoPersonaEntity.setIdRecursoPersona((Integer) row[36] );
            recursoPersonaEntity.setTipoDocumento((String) row[37] );
            recursoPersonaEntity.setNumeroDocumento((String) row[38] );
            recursoPersonaEntity.setNombresPersona((String) row[39]);
            recursoPersonaEntity.setFoto((String) row[40] );
            recursoPersonaEntity.setTipoPersona((String) row[41] );
            reEntity.setIntervenido(recursoPersonaEntity);
            RecursoPersonaEntity recursoPersonaEntity2 = new RecursoPersonaEntity();
            recursoPersonaEntity2.setIdRecursoPersona((Integer) row[42] );
            recursoPersonaEntity2.setTipoDocumento((String) row[43] );
            recursoPersonaEntity2.setNumeroDocumento((String) row[44] );
            recursoPersonaEntity2.setNombresPersona((String) row[45] );
            recursoPersonaEntity2.setFoto((String) row[46] );
            recursoPersonaEntity2.setPlaca((String) row[47] );
            recursoPersonaEntity2.setTipoPersona((String) row[48] );
            reEntity.setConductor(recursoPersonaEntity2);
            items.add(reEntity);
            pageable.setTotalRecords(SpUtil.toLong(row[49]));
    ...
    private Pageable<List<RecursoProductoEntity>> setResultDataListarRecursoEspecie(Page page, List<Object[]> dataDb) throws Exception {
        ...
        for (Object[] row : dataDb) {
            ...
            reEntity.setTxObservaciones((String) row[25]);
            items.add(reEntity);
    ...
    private Pageable<List<RecursoProductoEntity>> setResultDataListarRecursoVerProductos(Page page, List<Object[]> dataDb) throws Exception {
        ...
        for (Object[] row : dataDb) {
            ...
            rpeEntity.setNuIdDetTransferencia((Integer) row[21]);
            items.add(rpeEntity);
    ...
    private Pageable<List<RecursoProductoEntity>> setResultDataBuscarActaProductos(Page page, List<Object[]> dataDb) throws Exception {
        ...
        for (Object[] row : dataDb) {
            ...
            reEntity.setCantidadTotal((BigDecimal) row[24]);
            items.add(reEntity);
