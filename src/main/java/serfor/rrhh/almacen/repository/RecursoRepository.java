...
public interface RecursoRepository {
    ...
    List<RecursoProductoEntity> ListarRecursoEspeciePDF(Integer idEspecie, Integer idRecurso,
                                                               Page p) throws Exception;

    Pageable<List<RecursoProductoEntity>> ListarRecursoVerProductos(Integer nuIdAlmacen, String guiaForestal,
